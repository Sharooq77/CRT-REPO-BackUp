...
${BROWSER}                   chrome
${username}             sharooqali96@gmail.com
${Password}               Abbusharuk@123
...
Setup Browser
    ...
    # adds a delay of 0.2 between keywords. This is helpful in cloud with limited resources.
    SetConfig             Delay                       0.2
...
NoData
    VerifyNoText          ${0032w00001FWKI3AAP}                     timeout=3                        delay=2


DeleteAccounts
    [Documentation]       RunBlock to remove all data until it doesn't exist anymore
    ClickText             ${0032w00001FWKI3AAP}
    ClickText             Delete
