...
*** Variables ***
${SAP_URL}       https://gldusedv1.releaseowl.com    chrome
${SAP_USERNAME}  CRT_TEST
${SAP_PASSWORD}  CRT@123

*** Test Cases ***
Login to SAP
   Open Browser    ${SAP_URL}    chrome
    TypeText        Username    ${SAP_USERNAME}
    TypeSecret      Password    ${SAP_PASSWORD}
    ClickText       Log On
    VerifyText      SAP Easy Access
# *** Variables ***
